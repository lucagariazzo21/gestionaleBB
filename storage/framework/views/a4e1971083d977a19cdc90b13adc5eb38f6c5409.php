                                            ...
                                            <?php $__currentLoopData = $array[$date->format('Y-m-d')]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $camera => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <?php $__currentLoopData = $item; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>    
                                                    <?php if(isset($value['ora_arrivo'])): ?>
                                                        arriva <b class="text-primary"><?php echo e($value['nome']); ?></b> alle <b class="text-success"><?php echo e($value['ora_arrivo']); ?></b><br>
                                                    <?php elseif(isset($value['ora_partenza'])): ?>
                                                        parte <b class="text-primary"><?php echo e($value['nome']); ?></b> alle <b class="text-danger"><?php echo e($value['ora_partenza']); ?></b><br>
                                                    <?php else: ?>
                                                        occupata da <b class="text-primary"><?php echo e($value['nome']); ?></b> tutto il giorno<br>
                                                    <?php endif; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\test\resources\views/agenda.blade.php ENDPATH**/ ?>