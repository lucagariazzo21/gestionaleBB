                    ...
                    <div class="col-4 mt-4">
                        ...
                        <div class="alert alert-success" role="alert">
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <h3 class="float-right"><?php echo e($tot[$year]['ricavo']); ?> €</h3> 
                                </div>
                            </div>
                            <hr>
                            <div class="row">
                                ...
                                <div class="col">
                                    <h3 class="float-right"><?php echo e($tot[$year]['prenotazioni']); ?></h3>
                                </div>
                            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\test\resources\views/statistic.blade.php ENDPATH**/ ?>